...
const getLocalization = (key: string): string => {
  const localization: LocalizationService = {
    CDR_TotalOutboundStatistic: "Total Outbound Statistic",
  };
  return localization[key] || key;
};

const TotalOutboundStatisticCard: React.FC = () => {
  return (
      ...
      <div className="card box-shadow-0 border-dark-blue companyprofilecards">
        <div className="card-header card-head-inverse bg-dark-blue">
          <h4 className="card-title text-white titlesizeweight">
            ...
            {getLocalization("CDR_TotalOutboundStatistic")}
          </h4>
        ...
        <div className="card-content collapse show">
          <div className="card-body" id="OutboundStatistic">
            {/* <img
              ...
              alt="Loading..."
            /> */}
            <ProfileComponent total={55} answered={10} unanswered={45} />
          </div>
        </div>
      </div>
    </div>
...
export default TotalOutboundStatisticCard;
