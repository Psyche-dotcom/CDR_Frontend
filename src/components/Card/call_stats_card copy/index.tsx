...
const CallStatsCardCopy = forwardRef<HTMLCanvasElement, Props>(
  (
    { iconextraClass, buttonColor, title, cardId, cardPercentage, canvasId },
    ref
  ) => {
    return (
          ...
          <div className="card-content">
            ...
            <div className="row card-chart">
              <div className="col-12">
                <canvas
                  ref={ref} // The canvas ref is now forwarded
                  id={canvasId}
