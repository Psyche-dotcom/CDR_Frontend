...
!(function (e) {
  ...
  function S(e, t) {
    ...
    n.setAttribute("data-require-id", e), console.log(e);
    (n.src = k(e + ".js")),
      (n.async = !0),
            ...
            for (
              ...
              if (u) {
                var g = u.data,
                  f = h.series[e].data;
                if (
                  (g[V](t), f[V](t), n || (g[U](), (t = f[U]())), null != r)
                ) {
                  var y, b;
                  if (
    ...
    function (e) {
      ...
      return (
        ...
        (c.prototype.modElement = function (e, t) {
          return (
            this.storage.mod(e, t), (this._needsRefreshNextFrame = !0), this
          );
        }),
        (c.prototype.modLayer = function (e, t) {
          return (
            this.painter.modLayer(e, t),
      ...
      return (
        (t.prototype = {
            ...
            if (i.length > 0) {
              for (var r, n, a = 0, o = i.length; o > a; a++)
                (r = i[a].name),
                  ...
                  t[n].icon &&
                    (this._featureIcon[r] = t[n].icon[r] || t[n].icon),
                  t[n].color &&
            ...
            for (var V = this, U = 0; l > U; U++) {
              switch (
                ...
                this._featureIcon[this._iconList[U]] &&
                  ((t.style.image = this._featureIcon[
                    this._iconList[U]
              ...
              this._zoomStart &&
                ...
                this._iconShapeMap.dataZoom &&
                  this.zr.modShape(this._iconShapeMap.dataZoom.id, {
                    style: {
                      strokeColor:
                        this._iconShapeMap.dataZoom.highlightStyle.strokeColor,
                    },
                  }),
          ...
          reset: function (e, t) {
            ...
            if (s && s.show) {
              var h =
                  null != s.start && s.start >= 0 && s.start <= 100
                    ? s.start
                    : 0,
                d = null != s.end && s.end >= 0 && s.end <= 100 ? s.end : 100;
              h > d && ((h += d), (d = h - d), (h -= d)),
                (this._zoomQueue = [
                  { start: h, end: d, start2: 0, end2: 100 },
                ]);
                  ...
                  (t == s.CHART_TYPE_LINE || t == s.CHART_TYPE_BAR) &&
                    ((e =
                      this.option.xAxis instanceof Array
                        ? this.option.xAxis[
                            this.option.series[n].xAxisIndex || 0
                          ]
                        : this.option.xAxis),
                    e &&
                    ...
                    (e =
                      this.option.yAxis instanceof Array
                        ? this.option.yAxis[
                            this.option.series[n].yAxisIndex || 0
                          ]
                        : this.option.yAxis),
                    e &&
                      "category" === e.type &&
        ...
        (t.prototype = {
          ...
          _buildItem: function () {
            ...
            this.titleOption.textAlign &&
              (u.style.textAlign = V.style.textAlign =
                this.titleOption.textAlign),
          ...
          _getItemGroupLocation: function () {
            var e,
              ...
              l =
                ...
                ("" === n
                  ? 0
                  : this.titleOption.itemGap + s.getTextHeight(n, o)),
              h = this.zr.getWidth();
        ...
        (t.prototype = {
          ...
          _style: function (e) {
            ...
            n &&
              ...
              n.fontSize &&
                t.push(
                  "line-height:" + Math.round((3 * n.fontSize) / 2) + "px"
                ),
          ...
          _findAxisTrigger: function () {
            ...
            for (
              ...
              if (
                "axis" ===
                this.deepQuery([i[n], this.option], "tooltip.trigger")
              )
                return (
                  (e = i[n].xAxisIndex || 0),
                  (t = i[n].yAxisIndex || 0),
          ...
          _showItemTrigger: function (e) {
            if (this._curTarget) {
              ...
              this.deepQuery(V, "tooltip.axisPointer.show") &&
              this.component.grid
                ? this._styleAxisPointer(
                    [a],
                    this.component.grid.getX(),
              ...
              for (var o = 0, r = n.length; r > o; o++)
                (a += '<div style="padding-top:5px;">'),
                  n[o].detail &&
                    ...
                    (a +=
                      '<a href="' + n[o].detail.link + '" target="_blank">'),
            ...
            if ("auto" === i) {
              ...
              if (o > 3) {
                ...
                for (i = 0; !l && o > i; ) {
                  i++, (l = !0);
                  for (var d = i; o > d; d += i) {
                    if (((r = e[d].x - e[d - i].x), 0 !== t.label.rotate))
                      s = n;
      ...
      return (
        ...
        (t.prototype._start = function (e, t) {
          var i = n.merge(this.options, {
            ...
            l = 10,
            h = o.getTextWidth(
              s.highlightStyle.text,
              s.highlightStyle.textFont
            ),
            d = o.getTextHeight(
              s.highlightStyle.text,
              s.highlightStyle.textFont
      ...
      return (
        ...
        (t.prototype._start = function (e, t) {
          var i = n.merge(this.options, {
            ...
            h = 10,
            d = a.getTextWidth(
              l.highlightStyle.text,
              l.highlightStyle.textFont
            ),
            c = a.getTextHeight(
              l.highlightStyle.text,
              l.highlightStyle.textFont
        ...
        (d.prototype.getHighlightStyle = function (t, i, n) {
          ...
          "stroke" != t.brushType
            ...
            ? ((a.strokeColor = s),
              (a.lineWidth = (t.lineWidth || 1) + this.getHighlightZoom()))
            : (a.strokeColor =
                i.strokeColor || r.mix(t.strokeColor, r.toRGB(s)));
        ...
        (this.selectedMap = {}),
          ...
          (this.shapeHandler = {
            ...
            ondragover: function (e) {
              ...
              (i.brushType = "stroke"),
                (i.strokeColor =
                  o.ecTheme.calculableColor || h.calculableColor),
      ...
      return (
        (i.prototype = {
                  ...
                  null != i.value
                    ? ((s[o].data[r].value =
                      ...
                      (this.type === h.CHART_TYPE_FUNNEL ||
                        ...
                        (i.name +=
                          this.option.nameConnector + d.get(a, "name")),
                        l &&
                          l.add(i.name, a.style.color || a.style.strokeColor)))
                    : (s[o].data[r] =
                        "-" != i
          ...
          _buildMarkPoint: function (e) {
            ...
            for (
              var l = this._markPoint(e, o), r = 0, s = l.length;
              s > r;
              r++
            ) {
              var d = l[r];
            ...
            return function (i, n) {
              ...
              for (
                ...
                if (t(f[0]) && t(f[1])) {
                  ...
                  (f[0].tooltip = y.tooltip ||
                    n.tooltip || { trigger: "item" }),
                    (f[0].name = f[0].name || ""),
                    (f[1].name = f[1].name || ""),
                    (f[0].value = x),
                    m.push({
          ...
          addShapeList: function () {
            var e,
              t,
              i =
                this.option.animationThreshold / (this.canvasSupported ? 2 : 4),
      ...
      function n(e, t, n, a, o) {
        ...
        i(n, t, "x", "y", "width", "height"),
          ...
          (c[0] != t.position[0] || c[1] != t.position[1]) &&
            e.animate(n.id, "").when(a, { position: c }).start(o),
          (n.__animating = !0),
          e
            .animate(n.id, "style")
      ...
      function s(e, t, n, a, o) {
        t ||
          (t = {
            style: {
              x:
                "left" == n.style.textAlign ? n.style.x + 100 : n.style.x - 100,
              y: n.style.y,
            },
          });
        var r = n.style.x,
    ...
    function (e) {
      function t(e, t, i, n) {
        ...
        (a.style.x = i.style._x - U),
          ...
          "pin" == i.style.iconType &&
            (a.style.y -= (i.style.height / 2) * 1.5);
      ...
      function n(e, t, i, n, a) {
        ...
        a ||
          (o.clone(i, g), (g.position = i.position), t.push(g), e.addShape(g));
        var y = function () {
        ...
        if (i instanceof m) {
          ...
          for (
            var W = { p: 0 },
              X = e.animation.animate(W, { loop: s.loop }),
              v = 0;
            v < b.length;
            v++
          )
      ...
      return (
        (t.prototype = {
          ...
          getTextStyle: function (e) {
            return r.merge(
              r.merge(e || {}, this.ecTheme.textStyle),
              i.textStyle
            );
          },
        ...
        (o.prototype = {
          ...
          _calculateEdgeEdgeInk: (function () {
            ...
            return function (i, n, a, o) {
              ...
              var r =
                d(e[0], a) + d(a, o) + d(o, t[0]) + d(e[1], a) + d(o, t[1]);
              return r;
            };
          })(),
  ...
  define(
    "echarts/util/ecQuery",
    ["require", "zrender/tool/util"],
    function (e) {
      function t(e, t) {
        if ("undefined" != typeof e) {
          if (!t) return e;
          ...
          _optionToContent: function () {
            ...
            for (e = 0, a = d.length; a > e; e++) {
              for (r = [], t = 0, i = d[e].data.length; i > t; t++)
                (o = d[e].data[t]),
                  (h =
                    d[e].type == n.CHART_TYPE_PIE ||
                    d[e].type == n.CHART_TYPE_MAP
                      ? (o.name || "-") + ":"
                      : ""),
            ...
            return (
              "horizontal" == this.zoomOption.orient
                ...
                : ((i = this.zoomOption.width || this._fillerSize),
                  ...
                  (t =
                    null != this.zoomOption.y ? this.zoomOption.y : a.getY())),
            ...
            if (n instanceof Array) {
              ...
              if (this.isHorizontal())
                ...
                for (
                  ...
                  (s && !s(u, t[u]) && r > u) ||
                    ((V =
                      r > u ? this.getCoordByIndex(u) - h : this.grid.getY()),
                    (e = {
                      zlevel: this.getZlevelBase(),
                      z: this.getZBase(),
                      hoverable: !1,
              ...
              for (var d = 0; i > d; d++)
                (e = {
                  ...
                  style: {
                    ...
                    y: l,
                    color:
                      "function" == typeof s.color ? s.color(t[d]) : s.color,
